...
<?php startblock('body') ?>
  <body class="min-h-screen bg-gradient-to-b from-blue-200 to-white" style="font-family: lato">
      <div class="container mx-auto mt-8 pb-96">
          ...
          <div class="w-11/12 mx-auto shadow-bottom mt-24 p-10 border-y-2 rounded-3xl bg-gradient-to-l from-blue-100/50 to-green-100/50">
          ...
          <div class="w-11/12 mx-auto shadow-bottom mt-24 p-10 border-y-2 rounded-3xl bg-gradient-to-l from-blue-100/50 to-green-100/50">
              ...
              <div class="w-4/5 mx-auto p-10 my-5 rounded-2xl shadow bg-gradient-to-t from-green-100 to-slate-100">
                  ...
                  <ol class="text-blue-900 list-decimal mt-10">
                      ...
                      <li class="ml-10 text-lg">
                          ...
                          <code
                              class="text-sm text-green-700 text-base mr-1 p-1 px-3 rounded bg-slate-200">test_attempt_id</code>
                      </li>
                  </ol>
              ...
              <div class="w-4/5 mx-auto p-10 my-5 rounded-2xl shadow bg-gradient-to-t from-green-100 to-slate-100">
                  ...
                  <p class="text-blue-900 mb-4 text-base md:text-lg text-justify leading-[4rem]">
                      If you click on <span class="text-green-700 mr-1 ">VIEW ATTEMPTS</span>
                      you will be taken to the URL <span
                          class="text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">“ap/results/&lt;test_id&gt;”</span>
                      , where <code class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">test_id</code>
                      corresponds
                      to 1 for Test 1 and 2 for Test 2. This page will show you all the attempts for the corresponding
                      test along with <code
                          class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">start_time</code>,
                      <code class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">finish_time</code> along and
                      their
                      unique <code class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">test_label</code>.
                  </p>
                  <p class="text-blue-900 mb-4 text-base md:text-lg text-justify  leading-[4rem]">
                      An important thing to note here is that only <code
                          class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">test_attempt_label</code> of
                      these tests are stored in AutoProctor database
                      and the information about which <code
                          class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">test_attempt_id</code> maps to
                      which
                      <code class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">test_id</code> is not passed
                      on to
                      the AutoProctor database but is stored in local database only. Therefore if you look at <code
                          class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">getAllAttemptsDataByTestId()</code>method
                      inside <span
                          class="text-lg text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">autoproctor.php</span>, all
                      these results are first queried from local database based on the <code
                          class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">test_id</code> that they
                      belong to and
                      then the proctoring results for all the filtered test attempts are fetched
                      from AutoProctor database.
                  </p>

                  <ol class="text-blue-900 list-disc leading-[3rem] bg-white my-4 p-5 rounded-lg shadow">
                      <p class="text-blue-900 mb-4 text-base md:text-xl text-justify">
                          When you visit the page you will see all the test attempts for that specific test in a tabulated
                          form. The table has following columns:
                      </p>
                      ...
                      <li class="ml-10 text-lg my-3">
                          ...
                          Specifies Date and Time when test attempt was finished. This field will be empty if the attempt
                          was not submitted
                      </li>
                      <li class="ml-10 text-lg my-3">
                          <span class="text-green-700 mr-1 ">TEST COMPLETED-</span>
                          It says either YES or NO based on the whether or not the user completed the test
                      </li>
                      <li class="ml-10 text-lg my-3">
                          <span class="text-green-700 mr-1 ">TRUST SCORE-</span>
                          This column will display the trust score of a candidate in for each attempt in percentage. Trust
                          score will be based upon the evidence collected while the session was in progress
                      </li>
                      <li class="ml-10 text-lg my-3">
                          <span class="text-green-700 mr-1 ">REPORT-</span>
                          The links to each <code
                              class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">test_attempt_report</code>
                          are
                          listed in this column. Clicking on the listed link will load the report of that <code
                              class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">test_attempt</code>test_attempt
                      </li>
              ...
              <div class="w-4/5 mx-auto p-10 my-5 rounded-2xl shadow bg-gradient-to-t from-green-100 to-slate-100">
                  ...
                  <p class="text-blue-900 mb-4 text-base md:text-lg text-justify leading-[4rem]">
                      All the test attempt reports are available at the URL of the form <span
                          class="text-green-700 text-base mr-1 p-1 px-3 rounded bg-slate-200">“ap/report/&lt;test_attempt_id&gt;/?hashed_test_attempt_id=&lt;hashedTestAttemptId&gt;”</span>.
                      <code class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">test_attempt_id</code> has
                      already been explained.
                      <code class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">hashedTestAttemptId</code>
                      is generated using <code
                          class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">getHashedTestAttemptId</code>
                      method inside <span
                          class="text-lg text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">autoproctor.php</span>.
                      This method takes the <code
                          class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">testAttemptId</code> as
                      argument and generates a SHA-256 HMAC of the
                      <code class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">testAttemptId</code> with
                      your <code class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">CLIENT_SECRET</code>.
                      <a class="underline" href="">Click here</a> for more details about hashing.
                  </p>

                  <ol class="text-blue-900 list-decimal ">
                      <p class="text-blue-900 mb-1 text-base md:text-lg text-justify leading-[4rem]">
                          There are two ways you can end up at this URL:
                      </p>
                      <li class="ml-5">By clicking the <span class="text-green-700">'view report'</span>
                          link from the results page</li>
                      <li class="ml-5">By clicking the <span class="text-green-700">'view report'</span> link provided
                          when the test is finished
                      </li>
                  </ol>

                  <p class="text-blue-900 mb-1 text-xl md:text-xl mt-10 text-justify font-bold leading-[4rem]">
                      When you visit a particular report, you will see the following two sections there:
                  </p>
                  <ol class="text-blue-900 flex flex-col md:flex-row justify-around mt-5">
                      <li class="ml-5 text-white p-5 rounded shadow-xl px-20 bg-green-700 text-xl font-bold">1. &nbsp;
                          Report Overview</li>
                      <li class="ml-5 text-white p-5 rounded shadow-xl px-20 bg-green-700 text-xl font-bold">2. &nbsp;
                          Proctor Summary</li>
                  </ol>
                  ...
                  <div class="text-blue-900 list-decimal mt-12">
                      ...
                      <p class="text-blue-900 mb-1 text-base md:text-lg text-justify leading-[4rem]">
                          These sections are populated in a <code
                              class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">renderProctoringSummary</code>
                          function whenever the page loads. You
                          can see the function being called in the script inside <code
                              class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">report.php</code>. This
                          function takes a
                          javascript object as argument. This object has various properties which are explained below:
                      </p>

                      <ol class="text-blue-900 list-disc leading-[3rem] bg-white my-4 p-5 rounded-lg shadow">
                          <li class="ml-10 text-base my-3">
                              <code class="text-green-700 mr-1 ">renderOverview-</code>
                              This key takes a boolean value implying whether or not you want to display the Report
                              Overview section in your UI
                          </li>
                          <li class="ml-10 text-base my-3">
                              <code class="text-green-700 mr-1 ">proctorOverviewCtrId-</code>
                              This key expects a string value. The value of this property is the id of the
                              <code>html</code> container inside which you want to render the Report Overview
                          </li>
                          <li class="ml-10 text-base my-3">
                              <code class="text-green-700 mr-1 ">renderSummaryTable-</code>
                              This key also takes a boolean value implying whether or not you want to display the Proctor
                              Summary section in your UI
                          </li>
                          <li class="ml-10 text-base my-3">
                              <code class="text-green-700 mr-1 ">proctorOverviewCtrId-</code>
                              This key expects a string value. The value of this key is the id of the <code>html</code>
                              container inside which you want to render the Proctor Summary
                          </li>
                          <li class="ml-10 text-base my-3">
                              <code class="text-green-700 mr-1 ">userDetails-</code>
                              This key maps to a javascript object containing the details of the user. In our demo test we
                              have hard-coded the fields of this object, you can populate the fields according to your
                              preference
                          </li>
              ...
              <div class="w-4/5 mx-auto p-10 my-5 rounded-2xl shadow bg-gradient-to-t from-green-100 to-slate-100">
                  ...
                  <p class="text-blue-900 mb-4 text-base md:text-lg text-justify leading-[4rem]">
                      Occasionally, users may accidentally close the test tab or window, or they may refresh the page. In
                      such situations, the AutoProctor test can be resumed as long as the <code
                          class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">test_attempt_id</code> in the
                      URL
                      remains the same. Users can locate the URL on their auxiliary devices and utilize it to resume the
                      test, ensuring that all previously recorded evidence is preserved.

                  </p>

                  <p class="text-blue-900 mb-4 text-base md:text-lg text-justify leading-[4rem]">
                      However, if the user has already concluded the test, submitted the evidence, and generated a trust
                      score, resuming the test is not possible. If users attempt to do so, they will receive a prompt
                      informing them that the test with the specified <code
                          class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">test_attempt_id</code> has
          ...
          <div class="w-11/12 mx-auto shadow-bottom mt-24 p-10 border-y-2 rounded-3xl bg-gradient-to-l from-blue-100/50 to-green-100/50">
              ...
              <ol class="text-blue-900 list-decimal">
                  <p class="text-blue-900 mb-4 text-base md:text-xl text-justify">
                      The Section above explained how AutoProctor worked with our dummy tests. Getting it to work with
                      your quizzing solution is fairly straightforward (in principle, at least!). Let&apos;s say your
                      tests are being loaded on a route like /tests. You will need to:
                  </p>
                  <li class="ml-10 text-lg">Call the <code
                          class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">.init()</code> method with the
                      right set of parameters as mentioned above. The
                      most important parameters are the <code
                          class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">testAttemptId</code>, <code
                          class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">tenantId</code> and <code
                          class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">hashedTestAttemptId</code>
                  </li>
                  <li class="ml-10 text-lg">Listen to the event that confirms AutoProctor has successfully started
                  </li>
                  <li class="ml-10 text-lg">Load Your Test
                  </li>
                  <li class="ml-10 text-lg">When the test taker finishes the test, call the <code
                          class="text-sm text-green-700 mr-1 p-1 px-3 rounded bg-slate-200">autoProctorTest.stop()</code>method.
                      You can
                      trigger this by having an explicit Stop Proctoring button in your UI, or by somehow knowing that the
                      user has finished the test.
                  </li>
                  <li class="ml-10 text-lg">To load the results of a test attempt, initialize the AutoProctor SDK with the
                      relevant parameters
                  </li>
              </ol>
          </div>
